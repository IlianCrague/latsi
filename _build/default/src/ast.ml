...
and facteur = Var_f of var |Nombre_f of nombre | Expression_f of expression
...
and ligne = Ligne of nombre * instruction
...
and as_string_l = function
  |Ligne (n, instr) -> (as_string_n n) ^ " " ^ (as_string_instr instr)

and as_string_n (Nombre n) = string_of_int n
